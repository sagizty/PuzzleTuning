...
parser.add_argument('--data', default='/Users/munros/ROSE/MARS_MIL',
...
# additional configs:
parser.add_argument('--pretrained', default='/Users/munros/Desktop/moco_checkpoint_0000.pth.tar', type=str,
