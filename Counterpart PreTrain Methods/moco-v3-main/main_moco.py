...
parser.add_argument('data', default='/root/autodl-tmp/All',
...
parser.add_argument('--dist-backend', default='nccl', type=str,  # nccl是GPU设备上最快、最推荐的后端
...
def main_worker(gpu, ngpus_per_node, args):
        ...
        if args.basic_state_dict is not None:  # Transfer-learning
            try:
                ...
                if 'model' in basic_state_dict:
                    ...
                    pass
                model.load_state_dict(basic_state_dict, False)

            except:
                print('erro in args.basic_state_dict:', args.basic_state_dict)
                print('PreTuningRestart')  # 没倒进去

            else:
                print('PreTuning with Transfer-learning with:', args.basic_state_dict)

        else:
            print('PreTuning Restart')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            dataset_using = os.path.split(args.data)[1]
            if args.saveckp_freq and (epoch % args.saveckp_freq == 0 or epoch + 1 == args.epochs):
                save_checkpoint({
                    ...
                    filename=os.path.join('/home/CPIA/saved_models/MOCO', 'moco_' + initial_setting + '_' + dataset_using + '_checkpoint_%04d.pth.tar' % epoch))
                print('moco_' + initial_setting + '_' + dataset_using + '_checkpoint_%04d.pth.tar' % epoch)
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch % 10 == 0:
                save_checkpoint({
                    ...
                    'optimizer': optimizer.state_dict(),
                    'scaler': scaler.state_dict(),
                }, is_best=False, filename='moco_checkpoint_%04d.pth.tar' % epoch)
    if args.rank == 0:
        summary_writer.close()
